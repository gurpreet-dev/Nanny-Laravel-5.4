        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 m-auto">
                ...
                <div class="pr-inner-sec">
                    <div class="req-head">
                        <h5>In a Pinch</h5>
                        <h6>In a Pinch(Less Than 24 Hours Notice)</h6>
                    </div>
                    ...
                    <div class="row service">
                        ...
                        <form class="form-horizontal" name="Time-Form" method="Post" action="#" style="display:flex; flex-wrap:wrap; flex-direction:row">
                            ...
                            <div class="col-md-4">
                                <h4>Please select your services if more than just childcare in your home:</h4>

                                @foreach($services as $service)
                                @if(count($service->child_prices) > 0)
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input login-check" name="services[]" value="{{ $service->service->id }}"><span class="checkbox-style"></span><span class="checkbox-style-login">{{ $service->service->title }} (${{ $service->child_prices[0]->price }}/hr)</span>
                                    </label>
                                </div>
                                @endif
                                @endforeach
