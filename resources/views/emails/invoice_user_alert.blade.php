  ...
  <table width="600" border="0" cellpadding="10" cellspacing="0" style="margin:0px auto;background:#fffefb;text-align:center;font-family: 'Roboto Slab', serif;">
    <tbody>
     ...
     <tr style="margin: auto;width: 50%;display: block;">
      ...
      <tr style="margin: auto;width: 50%;display: block;">
        <td align="left" style="width: 100%;float: left; padding: 10px;"><span style="width: 50%;float: left;font-weight: 600;word-wrap: break-word;">Fine:</span> <span style="width: 50%;float: right;color: #6cb4a0;">${{ $invoice['due_price'] }}</span></td></tr>
      <tr style="margin: auto;width: 50%;display: block;">
